...
## Corpus Check
- 58 files · ~147,634 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 810 nodes · 1859 edges · 40 communities (34 shown, 6 thin omitted)
- Extraction: 96% EXTRACTED · 4% INFERRED · 0% AMBIGUOUS · INFERRED: 82 edges (avg confidence: 0.9)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `3ae29608`
...
Cohesion: 0.14
Nodes (20): borrarGuardado(), hayGuardado(), fx, Shell HTML del juego (canvas fx + #app + #overlay), Estructura de carpetas (core / ui / fx / estilos), PWA jugable sin conexión, juego(), pantallaBendicion() (+12 more)

### Community 3 - "Actos, mapa y guardado"
Cohesion: 0.12
Nodes (19): Presentador, CONTEMPLADOR, GOBLIN_ARQUERO, GOBLIN_CORTADOR, HERALDO_CULTO, IGNIFAX, shapeBBox(), Arquitectura: núcleo sin DOM + interfaz Presentador (+11 more)
...
Cohesion: 0.16
Nodes (16): CONJURO_PRODIGIOSO, DAGA, danoExplosion(), INICIALES_DE_CLASE, lanzarExplosion(), MAGO, NEUTRALES_ESPECIALES, POOLS (+8 more)
...
Cohesion: 0.05
Nodes (63): bbox(), Action, ACTION_DURATION, ActionProgress, activeAction(), applyMatrix(), BONE_ORDER, BoneId (+55 more)
...
Cohesion: 0.18
Nodes (12): PICARO, SELLO_PACTO, EstadoId, Acrobacias (pícaro), Clase Pícaro (66 PV), Condena (ejecuta al igualar los PV actuales), Robo y descarte con sinergias (pícaro), Quemadura (Aliento de Dragón de Ignifax) (+4 more)
...
Cohesion: 0.08
Nodes (61): BASE_PALETTE, c(), CLASS_LOOK, ClassLook, CREATURES, e(), FULL_SCENES, l() (+53 more)

### Community 19 - "Community 19"
Cohesion: 0.05
Nodes (57): BASICAS, Skill /editar-carta (aplica comentarios del Compendio), Convención: el texto de la carta debe cuadrar con su efecto, cardScene, hasFullArt(), lookOf(), place(), Compendio de cartas (+49 more)
...
Cohesion: 0.14
Nodes (18): crearEspacios(), ORDEN_NIVELES, piramideConjuros(), barajar(), ContextoEfecto, EfectoConjuro, EfectoInvocacion, EfectoTemporal (+10 more)
...
Cohesion: 0.11
Nodes (18): BARBARO, Actualizaciones y avisos, Ambientación fantasía medieval D&D, Arte de las cartas, Clase Bárbaro (80 PV), Controles, Roguelike de construcción de mazos, Diseño (+10 more)
...
Cohesion: 0.21
Nodes (10): recompensaCartas(), GUANTE_LADRON, HACHA_ANCESTRO, PENDULO_AMBAR, POOL_RELIQUIAS, TOTEM_ROBLE, CartaDef, ReliquiaDef (+2 more)

### Community 32 - "Community 32"
Cohesion: 0.33
Nodes (9): mazoInicial(), generarMapa(), reliquiaInicial(), crearRng(), avanzarCapitulo(), nuevaRun(), Mapa de 10 filas por capítulo, mejorObjetivo() (+1 more)

### Community 33 - "Community 33"
Cohesion: 0.47
Nodes (4): nodosDisponibles(), NodoMapa, ICONO_NODO, NOMBRE_NODO

### Community 36 - "Community 36"
Cohesion: 0.23
Nodes (8): cartaUnicaDeClase(), OpcionEvento, elegir(), EstadoRun, Don, DON_CARTA, DONES, anuncio()

### Community 39 - "Community 39"
Cohesion: 0.16
Nodes (12): BRUJO, DRUIDA, PV_POR_CLASE, FormaInvocacion, Invocacion, Clase Brujo (64 PV), Clase Druida (70 PV), Invocación del druida (+4 more)
...
## Knowledge Gaps
- **221 isolated node(s):** `version`, `configurations`, `name`, `private`, `version` (+216 more)
...
- **Why does `Combate` connect `Motor de combate` to `Community 34`, `Actos, mapa y guardado`, `Community 36`, `Community 39`, `Community 13`, `Community 16`, `Community 19`, `Community 23`, `Community 30`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `Mazo y Mazmorra` connect `Community 27` to `Audio y música`, `Community 39`, `Eventos y recompensas`, `Community 13`, `Configuración de Vite y PWA`?**
